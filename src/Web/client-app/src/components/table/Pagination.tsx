...
const Pagination: React.FC<IPagination> = ({ currentPage = 1, totalPage = 1, handleChange }) => {
    const JUMP_ITEMS = 2;
    ...
    const renderMidPaging = (page: number, total: number) => {
        let prevItems = page - JUMP_ITEMS > 1 
                            ? page - JUMP_ITEMS 
                            : 2;

        let nextItems = page + JUMP_ITEMS < total 
                            ? page + JUMP_ITEMS 
                            : total - 1;
