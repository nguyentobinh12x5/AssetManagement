...
const ReturningSlice = createSlice({
    ...
    name: 'returning',
    reducers: {
        setReturningQuery: (state: ReturningState, action: PayloadAction<IReturningQuery>) => {
            return {
                ...state,
        ...
        getReturnings: (state: ReturningState, action: PayloadAction<IReturningQuery>) => ({
            ...state,
            isLoading: true,
        }),
...
export const { getReturnings, setReturningQuery,getReturningsSuccess, getReturningsFailure } =
