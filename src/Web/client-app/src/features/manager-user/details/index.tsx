      ...
      <Modal.Body>
        <div id="detailed_user">
          ...
          <svg className="background_kxh" viewBox="0 0 480 315.713">
            <path
              id="background_kxh"
              d="M 0 0 L 480 0 L 480 307.4263610839844 C 480 312.0028381347656 475.5228576660156 315.7127685546875 470 315.7127685546875 L 10 315.7127685546875 C 4.477152347564697 315.7127685546875 0 312.0028381347656 0 307.4263610839844 L 0 0 Z"
            ></path>
          </svg>
          ...
          <div id="Type_kxz">
            ...
            <svg className="Path_8_kx" viewBox="0 0 280 35">
              <path
                id="Path_8_kx"
                d="M 6 0 L 275 0 C 277.7614135742188 0 280 2.238576173782349 280 5 L 280 30 C 280 32.76142501831055 277.7614135742188 35 275 35 L 5 35 C 2.238576173782349 35 0 32.76142501831055 0 30 L 0 5 C 0 2.238576173782349 3.238576173782349 0 6 0 Z"
              ></path>
            </svg>
            <div id="Staff_kx">
              <span>{user.type}</span>
          ...
          <div id="First_Name_kx">
            ...
            <svg className="Path_15_kx" viewBox="0 0 1 1">
              <path id="Path_15_kx" d="M 0 0"></path>
            </svg>
          </div>
